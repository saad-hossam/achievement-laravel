                    ...
                    <div class="slider-column" data-content-type="images">
                        <div class="slider">
                            ...
                            <div class="main-image-container" id="mainImageContainer">
                                @php
                                    // Get the first image media for main display
            ...
            <div class="container">
                ...
                <div class="main-video-container">
                    <div class="main-video-player">
                        <iframe
                            id="mainVideoPlayer"
                            src="{{ $firstVideo ? 'https://www.youtube.com/embed/' . $firstVideo->video_id : 'https://www.youtube.com/embed/dQw4w9WgXcQ' }}"
                            frameborder="0" allowfullscreen>
                        </iframe>

                        <button class="fullscreen-btn" onclick="openVideoModal(document.getElementById('mainVideoPlayer').src)"
                                title="Fullscreen" data-i18n-title="fullscreen">
...
<div class="play-button" title="Play Video" data-i18n-title="watch_video">
    ...
    <div id="fullscreenOverlay" class="fullscreen-overlay">
        ...
        <div class="overlay-footer">
            <span id="currentImageIndex">1</span> / <span id="totalImages">{{ $achievement->media->where('type', 'image')->count() }}</span>
        </div>
    </div>
