            ...
            <div class="card border-0 bg-transparent">
              <div class="card-body px-md-4 bg-transparent">
                ...
                <div class="d-flex mt-4">
                  <div class="me-3">
                    <span class="badge p-2 rounded-pill"><i class="fas fa-star me-1"></i> <span data-lang="leadership">Leadership</span></span>
                  </div>
                  <div class="me-3">
                    <span class="badge p-2 rounded-pill"><i class="fas fa-gear me-1"></i> <span data-lang="engineering">Engineering</span></span>
                  </div>
                  <div class="me-3">
                    <span class="badge p-2 rounded-pill"><i class="fas fa-shield-alt me-1"></i> <span data-lang="military">Military</span></span>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="row">
                  <div class="col-12">
                    <ul class="list-group list-group-flush medal-list">
                      <li class="list-group-item border-0 d-flex align-items-center px-0" data-lang="medal1"><i
                          class="fas fa-award text-warning me-2"></i> Long Service and Good Conduct Medal</li>
                      <li class="list-group-item border-0 d-flex align-items-center px-0" data-lang="medal2"><i
                          class="fas fa-award text-warning me-2"></i> Silver Jubilee Medal for the Liberation of Sinai
                      </li>
                      <li class="list-group-item border-0 d-flex align-items-center px-0" data-lang="medal3"><i
                          class="fas fa-award text-warning me-2"></i> Silver Jubilee Medal for the October 1973 Victory
                      </li>
                    </ul>

                    <div class="collapse" id="moreMedals">
                      <ul class="list-group list-group-flush medal-list">
                        <li class="list-group-item border-0 d-flex align-items-center px-0" data-lang="medal4"><i
                            class="fas fa-award text-warning me-2"></i> 50th Anniversary Medal for the July 23, 1952
                          Revolution</li>
                        <li class="list-group-item border-0 d-flex align-items-center px-0" data-lang="medal5"><i
                            class="fas fa-award text-warning me-2"></i> January 25 Revolution Medal</li>
                        <li class="list-group-item border-0 d-flex align-items-center px-0" data-lang="medal6"><i
                            class="fas fa-award text-warning me-2"></i> June 30, 2013 Medal</li>
                        <li class="list-group-item border-0 d-flex align-items-center px-0" data-lang="medal7"><i
                            class="fas fa-award text-warning me-2"></i> Second Class Military Duty Decoration</li>
                        <li class="list-group-item border-0 d-flex align-items-center px-0" data-lang="medal8"><i
                            class="fas fa-award text-warning me-2"></i> Excellent Service Decoration</li>
                        <li class="list-group-item border-0 d-flex align-items-center px-0" data-lang="medal9"><i
                            class="fas fa-award text-warning me-2"></i> Order of the Republic – Second Class</li>
                      </ul>
                    </div>
            ...
            <div class="timeline">
              ...
              <div class="collapse" id="morePositions">
                <div class="timeline-item">
                  <div class="timeline-marker"></div>
                  <div class="timeline-content">
                    <h4 class="position-title" data-lang="pos6">General Manager of Al-Nasr Company for Bottling Natural
                      Water (Safi)</h4>
                ...
                <div class="timeline-item">
                  <div class="timeline-marker"></div>
                  <div class="timeline-content">
                    <h4 class="position-title" data-lang="pos5">General Manager of the National Company for Intermediate
                      Chemicals</h4>
