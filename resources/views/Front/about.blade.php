        ...
        <div class="card border-0 bg-transparent">
          <div class="card-body px-md-4 bg-transparent">
            ...
            <div class="d-flex mt-4">
              <div class="me-3">
                <span class="badge p-2 rounded-pill"><i class="fas fa-star me-1"></i> Leadership</span>
              </div>
              <div class="me-3">
                <span class="badge p-2 rounded-pill"><i class="fas fa-gear me-1"></i> Engineering</span>
              </div>
              <div class="me-3">
                <span class="badge p-2 rounded-pill"><i class="fas fa-shield-alt me-1"></i> Military</span>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="row">
      ...
      <div class="col-md-6 mb-4">
        <div class="card h-100 shadow hover-card border-0">
          <div class="card-body border-color-white">
            <div class="d-flex align-items-center mb-3">
              <i class="fas fa-medal fs-3 me-3"></i>
    ...
    <div class="card shadow mb-4 hover-card  border-0">
      <div class="card-body">
        <div class="d-flex align-items-center mb-4">
          <i class="fas fa-briefcase fs-3 me-3"></i>
