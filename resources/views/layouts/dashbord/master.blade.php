...
<body class="main-body app sidebar-mini">
    ...
    <!-- /Loader -->
    @include('includes.dashboard.main-sidebar')
    <!-- main-content -->
    <div class="main-content app-content">
        @include('includes.dashboard.main-header')
        <!-- container -->
        <div class="container-fluid">
            @yield('page-header')
            @yield('content')
            @include('includes.dashboard.sidebar')
            @include('includes.dashboard.models')
            @include('includes.dashboard.footer-scripts')
            @yield('scripts')
</body>
