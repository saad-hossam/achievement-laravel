                        ...
                        <div class="row">
                            <div class="col-md-10 col-lg-10 col-xl-9 mx-auto">
                                <div class="card-sigin ">
                                    <div class="mb-2 d-flex text-center"> <a href="{{ url('/' . $page='Home') }}"><img src="{{URL::asset('assets/img/logo.png')}}" class="sign-favicon ht-40" alt="logo"></a><h1 class="main-logo1 ml-1 mr-0 my-auto tx-28">انجا زات الهيئة العربية للتصنيع </h1></div>
                                    <div class="card-sigin">
            ...
            <div class="col-md-6 col-lg-6 col-xl-7 p-0 d-none d-md-flex bg-primary-transparent">
                <div class="row wd-100p  text-center">
                    <div class="col-md-12 col-lg-12 col-xl-12 ">
                        <img src="{{URL::asset('assets/img/logo2.jpg')}}" class=" ht-xl- wd-md-100p " style="height: 100%" alt="logo">
                    </div>
                </div>
            </div>
