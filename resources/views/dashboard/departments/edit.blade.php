                    ...
                    <div class="card">
                        ...
                        <div class="card-block">
                            ...
                            <div class="tab-content" id="myTabContent">
                                ...
                                {{-- @dd($department->translate($key)->name) --}}
                                <div class="tab-pane mt-3 fade @if ($loop->index == 0) show active in @endif" id="{{ $key }}" role="tabpanel" aria-labelledby="{{ $key }}-tab">
                                    <div class="form-group mt-3 col-md-12">
                                        ...
                                        <input type="text" name="{{ $key }}[name]" id="name-{{ $key }}" class="form-control" placeholder="الاسم" required value="{{ old($key . '.name', strip_tags(optional($department->translate($key))->name ?? '')) }}">
                                    </div>
                                </div>
            ...
            <div class="row row-xs formgroup-wrapper">
                ...
                <div class="col-md-6 mg-t-20 mg-md-t-0">
                    ...
                    <div class="form-group mt-2">
                        ...
                        <a href="{{ asset('images/departments/' . $department->image) }}" target="_blank"><img src="{{ asset('images/departments/' . $department->image) }}" alt="department Image" class="img-thumbnail" width="70" height="70">
                        </a>
                    </div>
                    @endif
